...
CREATE TABLE IF NOT EXISTS `senicare`.`nurses` (
  ...
  `tel_number` VARCHAR(11) NOT NULL DEFAULT 'HOME' COMMENT '요양사 전화번호',
...
CREATE TABLE IF NOT EXISTS `senicare`.`tools` (
  ...
  `purpose` TEXT NOT NULL COMMENT '용품용도',
