...
import com.kbit.senicare.common.util.AuthNumberCreator;
...
import com.kbit.senicare.provider.JwtProvider;
import com.kbit.senicare.provider.SmsProvider;
import com.kbit.senicare.repository.NurseRepository;
import com.kbit.senicare.repository.TelAuthNumberRepository;
import com.kbit.senicare.service.AuthService;
...
public class AuthServiceImplement implements AuthService{
    ...
    public ResponseEntity<ResponseDto> idCheck(IdCheckRequestDto dto) {
        ...
        try {
            ...
            boolean isExisted = nurseRepository.existsByUserId(userId);
    ...
    public ResponseEntity<ResponseDto> telAuth(TelAuthRequestDto dto) {
        ...
        try {
            ...
            boolean isSendSuccesss = smsProvider.sendMessage(telNumber, authNumber);
            if (!isSendSuccesss) return ResponseDto.messageSendFail();
    ...
    public ResponseEntity<ResponseDto> telAuthCheck(TelAuthCheckRequestDto dto) {
        ...
        String telNumber = dto.getTelNumber();
        String autNumber = dto.getAuthNumber();

        try {
            boolean isMatched = telAuthNumberRepository.existsByTelNumberAndAuthNumber(telNumber, autNumber);
